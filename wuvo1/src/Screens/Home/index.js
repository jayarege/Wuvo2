...
function HomeScreen({ seen, unseen, genres, newReleases, isDarkMode, toggleTheme, onAddToSeen }) {
              ...
              >
                ...
                <View style={styles.genreScoreContainer}>
                  ...
                  <View style={styles.genreRank}>
                    <Text style={[styles.genreRankText, { color: isDarkMode ? '#D3D3D3' : '#666' }]}>
                      #{index + 1}
                    </Text>
                  </View>
                </View>
        ...
        >
          {newReleases.slice(0, 10).map(movie => (
            <TouchableOpacity
              ...
              style={[
                styles.movieCard,
                { backgroundColor: isDarkMode ? '#2A3132' : '#F5F5F5', marginRight: 12 }
              ]}
              activeOpacity={0.7}
            ...
            >
              ...
              <View style={styles.popularScoreContainer}>
                ...
                <Text style={{ fontSize: 12, color: isDarkMode ? '#FFD700' : '#FFA000', marginLeft: 4 }}>
  ...
  }, [isDarkMode, newReleases, handleMovieSelect]);
